...
*
* FILENAME: sgemm2_L2_B64_ndrange.cl		DESIGN REF: hydra00
*
...
__kernel void sgemm2(const int M, const int K, const int N, const __global float *restrict A, const __global float *restrict B, __global float *restrict C) 
{
	...
	// Local Memory, Speed inncrease on the way!
  	...
  	/*
          A simple note to help me remember the complicated range
  	...
  	*/
  	...
  	// Calculate sub-blocks for row and columns
  	...
  	for (int tile = 0; tile < TOTAL_TILES; tile++) 
  	{
    		...
    		// stash the values in local memory
